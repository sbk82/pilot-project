...
exports.cpuInfo = function (callback) {
    getCPUInfo2(callback);
}

exports.cpuInfo3 = function (callback) {
    getCPUInfo3(callback);
}
...
function getCPUInfo3(callback) {
    ...
    // var p_i = free/counter;
    // var p_u = user/counter;
    // var p_s = sys/counter;
